...
- Designed Power Amplifier (PA) with ±1 dBm output power accuracy across corners with adaptive bias circuit
...
### 🔄 [Filter_optimizer using Ngspice and python and shell scripting](https://github.com/kirolos222/Schell_scripting_training)
